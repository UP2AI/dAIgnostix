...
Uses system-determined kategori from adaptive posttest.
"""
...
async def get_feedback(nip: str):
    ...
    kategori and jalur are determined by the adaptive posttest system.
    """
    ...
    # Get adaptive test results
    kategori = posttest.get("kategori") or "Menengah"
    ...
    # Enrich response with scores, profile, and adaptive info
    if isinstance(feedback_data, dict):
        ...
        feedback_data["jalur"] = jalur
        feedback_data["kategori"] = kategori
