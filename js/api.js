...
async function savePosttestAnswer(nip, nomor, jawaban) {
    return apiCall(`/posttest/${nip}/save-answer`, 'POST', { nomor, jawaban });
}

async function postCheckpoint(nip) {
    return apiCall(`/posttest/${nip}/checkpoint`, 'POST');
}
